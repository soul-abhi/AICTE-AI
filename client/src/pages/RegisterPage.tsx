...
export default function RegisterPage() {
  return (
    <div className="mx-auto max-w-md rounded-2xl bg-white/80 p-8 shadow-lg ring-1 ring-slate-200 dark:bg-slate-900/80 dark:ring-slate-800">
      <h2 className="text-2xl font-semibold">Registration removed</h2>
      <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
        Registration and account creation have been disabled. Continue using the app without an account.
      </p>
      <div className="mt-6">
